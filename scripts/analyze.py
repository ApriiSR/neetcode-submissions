...
SYSTEM_PROMPT = (
    ...
    "\"correctness_reason\", wrap any phrase that gives away a technique the "
    "submitted solution does not already use in double pipes: ||like this||. "
    ...
    "approach normally has no bars at all. Never wrap a whole field. If "
